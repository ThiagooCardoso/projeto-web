...
function criarTabelaDietaseInsumos() {
    ...
    var queryInsumos = "CREATE TABLE IF NOT EXISTS dietaInsumos (id INTEGER PRIMARY KEY, idInsumo INTEGER NOT NULL, idDieta TEXT NOT NULL, nomeInsumo TEXT NOT NULL, qtdInsumos REAL NOT NULL, duracao INTEGER NOT NULL)"
